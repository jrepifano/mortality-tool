...
def load_new_data(split=False, resample=False):
    dir = os.getcwd()
    X = np.load(dir + '/data/x_eicu_all.npy')
    y = np.load(dir + '/data/y_eicu_all.npy')[:, 1]
    loc = np.load(dir + '/data/75_tol_feats.npy')
    X = X[:, loc]
    feats = ['lactate', 'eyes', 'oobintubday1', 'oobventday1', 'motor', 'verbal',
    ...
    select = ['lactate', 'oobventday1', 'eyes', 'motor', 'verbal', 'albumin_y',
            'age', 'creatinine_x', 'BUN', 'PT - INR', 'WBC x 1000', 'meanbp', 'phosphate']
    idx = [feats.index(feat) for feat in select]
    X = X[:, idx]
...
def create_model(num_layers):
    ...
    for layer in range(num_layers):
        in_feats = out_feats if layer != 0 else 13
...
def main():
    ...
    snr = 10
    if split == True:
        X_train, X_test, y_train, y_test = load_new_data(split, resample)
        y_test_true = y_test
    ...
    model.to('cuda:0')
    criterion = torch.nn.BCEWithLogitsLoss(pos_weight=torch.tensor([12.79], device='cuda:0'))
    ...
    for epoch in range(num_epochs):
        ...
        #     print('lr changed from {} to {}'.format(prev_lr, optimizer.param_groups[0]['lr']))
    ...
    # plt.ylabel(['Loss'])
    # plt.legend()
    # plt.savefig(os.getcwd() + '/results/lr_anneal/' + metrics[0])
    # plt.clf()
    # plt.cla()
    # plt.close()
    ...
    # plt.ylabel(['Accuracy'])
    # plt.legend()
    # plt.savefig(os.getcwd() + '/results/lr_anneal/' + metrics[1])
    # plt.clf()
    # plt.cla()
    # plt.close()
    ...
    # plt.legend()
    # plt.savefig(os.getcwd() + '/results/lr_anneal/' + metrics[2])
    # plt.clf()
    # plt.cla()
    # plt.close()
    ...
    # plt.legend()
    # plt.savefig(os.getcwd() + '/results/lr_anneal/' + metrics[3])
    # plt.clf()
    # plt.cla()
    # plt.close()
    ...
    # plt.legend()
    # plt.savefig(os.getcwd() + '/results/lr_anneal/' + metrics[4])
    # plt.clf()
    # plt.cla()
    # plt.close()
    ...
    # plt.ylabel(['ROC AUC'])
    # plt.legend()
    # plt.savefig(os.getcwd() + '/results/lr_anneal/' + metrics[5])
    # plt.clf()
    # plt.cla()
    # plt.close()
    ...
    # plt.ylabel(['PRC AUC'])
    # plt.legend()
    # plt.savefig(os.getcwd() + '/results/lr_anneal/' + metrics[6])
    # plt.clf()
    # plt.cla()
    # plt.close()
    ...
    # plt.legend()
    # plt.savefig(os.getcwd() + '/results/lr_anneal/' + metrics[7])
    # plt.clf()
    # plt.cla()
    # plt.close()
